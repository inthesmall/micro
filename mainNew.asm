...
;##### General routines #####
scorePrint:			; This is a hex->decimal converter, only works on numbers <= 99. Code adapted from J. Nash, Imperial College. From 'Extra Examples' presentation on the Microprocessors course.
	push r16
	push r17
	clr r7
	clr r8
